...
unRAID Docker Templates for Docker images in the "OFark" repository.
...
2. Enter in a URL of https://github.com/OFark/docker-templates in the "Template repositories" field
